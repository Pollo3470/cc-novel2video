...
基于 Claude Code Skills 的 AI 漫剧视频生成工具，将小说内容自动转换为可发布的短视频。
...
`.claude/skills/novel-to-script/references/script_format.md`
